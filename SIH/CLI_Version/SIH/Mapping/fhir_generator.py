...
class FHIRConditionGenerator:
    ...
    def _build_code_element(
        ...
        tm_system_url = {
            ...
            "ayurveda-sat": "http://who.int/icd/tm2/ayurveda-sat"
        }
        
        tm_coding = {
            "system": tm_system_url.get(tm_system, "http://who.int/icd/tm2"),
            "code": tm_code,
            "display": tm_english or tm_term
        }
...
def generate_fhir_from_mapping(
    ...
    # Normalize system key (replace hyphen with underscore for dictionary key access)
    system_key = system.replace("-", "_")
    candidates_key = f"{system_key}_candidates"
