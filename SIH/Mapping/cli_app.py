...
class TMICDMapper:
    ...
    def main_menu(self):
        ...
        while True:
            self.clear_screen()
            self.print_header("Traditional Medicine → ICD-11 Mapping System")
            ...
            print(f"  {Colors.BLUE}6.{Colors.ENDC} Reset Session")
            print(f"  {Colors.BLUE}0.{Colors.ENDC} Exit")
            
            # Show current status
            if self.current_system:
                print(f"\n{Colors.GREEN}Current System: {self.current_system.upper()}{Colors.ENDC}")
    ...
    def select_system(self):
        ...
        systems = {'1': 'siddha', '2': 'ayurveda', '3': 'unani'}
        
        if choice in systems:
            self.current_system = systems[choice]
            self.print_success(f"Selected system: {self.current_system.upper()}")
            self.wait_for_enter()
        elif choice == '0':
            return
        else:
    ...
    def search_diagnosis(self):
        ...
        self.clear_screen()
        self.print_header(f"Search {self.current_system.upper()} Diagnosis")
        ...
        self.print_info(f"Searching {self.current_system.upper()} database...")
    ...
    def select_tm_candidate(self):
        ...
        self.clear_screen()
        self.print_header(f"{self.current_system.upper()} Candidates")
    ...
    def view_selections(self):
        ...
        print(f"  System: {Colors.GREEN}{self.current_system.upper()}{Colors.ENDC}")
